...
13. Right-Click on Tables and create a new one. Call it **tickets**. Add two columns named ``guild_id (PK)`` and ``ticket_id``. It should look like [this](https://cdn.discordapp.com/attachments/771635939700768769/827828250683244564/unknown.png).
